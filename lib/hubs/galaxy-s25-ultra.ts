...
export const galaxyS25Ultra: HubConfig = {
  ...
  affiliate: {
    allowed: true,
    slots: [
      { slot: 's25u-body', label: 'S25 울트라 자급제', network: 'coupang', kind: 'device', targetUrl: 'https://link.coupang.com/re/AFFSDP?lptag=AF3904190&pageKey=9187805942&itemId=27106552110&vendorItemId=95897701835&traceid=V0-153-ac00f0153f24ef6d&requestid=20260824032334293173850512&token=31850C%7CMIXED' },
      { slot: 's25u-spen', label: 'S25 울트라 호환 S펜', network: 'coupang', kind: 'accessory', targetUrl: 'https://link.coupang.com/re/AFFSDP?lptag=AF3904190&pageKey=8591417691&itemId=24910467562&vendorItemId=92055522299&traceid=V0-153-461e2dc210908a0b&clickBeacon=fc29a400-9bfb-11f1-ae87-41ab07e173d3%7E3&requestid=20260820032959421287453326&token=31850C%7CMIXED' },
