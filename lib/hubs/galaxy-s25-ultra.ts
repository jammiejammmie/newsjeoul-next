...
export const galaxyS25Ultra: HubConfig = {
  ...
  affiliate: {
    allowed: true,
    slots: [
      { slot: 's25u-body', label: 'S25 울트라 자급제', network: 'coupang', kind: 'device', targetUrl: 'https://link.coupang.com/re/AFFSDP?lptag=AF3904190&pageKey=9707464240&itemId=29042725148&vendorItemId=95969799361&traceid=V0-153-398a3aeb4327fb07&requestid=20260907045753439307128753&token=31850C%7CMIXED&pt=0&slot=6' },
