...
export const galaxyBook5Pro: HubConfig = {
  ...
  affiliate: {
    allowed: true,
    slots: [
      { slot: 'book5-body', label: '갤럭시북5 프로', network: 'coupang', kind: 'device', targetUrl: 'https://link.coupang.com/re/AFFSDP?lptag=AF3904190&pageKey=8524610232&itemId=25325894640&vendorItemId=94112243243&traceid=V0-153-59873d5649e2e5c4&clickBeacon=b5cc2420-b464-11f1-ad3e-52f790132784%7E3&requestid=20260920050006421097410581&token=31850C%7CMIXED&pt=1&slot=1' },
