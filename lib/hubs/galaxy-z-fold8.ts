...
export const galaxyZFold8: HubConfig = {
  ...
  affiliate: {
    ...
    slots: [
      ...
      { slot: 'fold8-case', label: '폴드8 힌지보호 케이스', network: 'coupang', kind: 'accessory', targetUrl: 'https://link.coupang.com/re/AFFSDP?lptag=AF3904190&pageKey=9692446725&itemId=28989248015&vendorItemId=95918062981&traceid=V0-153-22b90bc93f4b3e44&requestid=20260827044416746000090061&token=31850C%7CMIXED' },
