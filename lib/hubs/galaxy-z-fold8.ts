...
export const galaxyZFold8: HubConfig = {
  ...
  affiliate: {
    ...
    slots: [
      ...
      { slot: 'fold8-case', label: '폴드8 힌지보호 케이스', network: 'coupang', kind: 'accessory', targetUrl: 'https://link.coupang.com/re/AFFSDP?lptag=AF3904190&pageKey=9660172510&itemId=29046245856&vendorItemId=95811448965&traceid=V0-153-32c0df4ee08784b7&requestid=20260828110107035205715509&token=31850C%7CMIXED' },
