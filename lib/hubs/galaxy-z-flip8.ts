...
export const galaxyZFlip8: HubConfig = {
  ...
  affiliate: {
    ...
    slots: [
      ...
      { slot: 'flip8-case', label: '플립8 전용 케이스', network: 'coupang', kind: 'accessory', targetUrl: 'https://link.coupang.com/re/AFFSDP?lptag=AF3904190&pageKey=9649890432&itemId=28841797783&vendorItemId=95775916718&traceid=V0-153-12c6a59f5818e2d8&requestid=20260901072355668228973013&token=31850C%7CGM' },
